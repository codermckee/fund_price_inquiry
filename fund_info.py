...
if __name__ == '__main__':
    try:
        ...
        print '2018-2-6 年前一周 多支基金跳水，如白酒！'
        ...
        print '华 安 策 略 优 选--040008'
        inquire_fund(url_fund('040008'))
        print '华 宝 兴 业--241001'
        inquire_fund(url_fund('241001'))
        print '长 信 量 化 先 锋--519983(持仓)￥￥1.5830--(1.51加仓&1.57考虑加仓)'
        inquire_fund(url_fund('519983'))
        print '富 国 中 证 军 工--161024(持仓)￥￥0.92--(低迷)'
        inquire_fund(url_fund('161024'))
        print '融 通 深 证 100--161604(持仓)￥￥1.403//￥￥1.2030'
